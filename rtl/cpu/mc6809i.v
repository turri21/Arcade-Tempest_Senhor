...
// Revision 1.1 - Fixed SEX instruction condition code updates (N, Z, V flags)
// Revision 1.2 - Integrated Jotego's registered s_wr NMI mask clearing optimization
//                and RndMnkIII's active-low Reset interrupt latch fix
//
//////////////////////////////////////////////////////////////////////////////////
...
begin
    if (CE_E_FALL) begin
        ...
        begin
            ...
            if (s_wr)                       // Once S is loaded explicitly, release the NMI Mask.
                NMIMask <= 1'b0;
        end
        else
        begin
            CpuState <= CPUSTATE_RESET; 
            IRQLatched <= 1'b1;             // Clear pending interrupts during Reset (RndMnkIII)
            FIRQLatched <= 1'b1;            // Clear pending interrupts during Reset (RndMnkIII)
...
begin
    ...
    tmp_nxt    =  tmp;
    ea_nxt     =  ea;
    s_wr       =  1'b0; // Default: S register is not written
        ...
        begin
            ...
            case (AddrModeType)
                ...
                begin
                    ...
                    begin
                        a_nxt = {8{b[7]}};
                        cc_nxt[CC_N_BIT] = b[7];           // Rev 1.1: SEX must update N,Z flags per 6809 datasheet
